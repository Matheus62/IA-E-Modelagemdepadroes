 ...
 * @author EAS
 */
public class NavioCadastro extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(NavioCadastro.class.getName());
    ...
    private void initComponents() {
        ...
        Furtivo.setText("Navio furtivo");
        Furtivo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                FurtivoActionPerformed(evt);
            }
        });

        buttonGroup1.add(Guerra);
        Guerra.setText("Navio de guerra");
    ...
    private void FurtivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FurtivoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_FurtivoActionPerformed
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (Furtivo.isSelected())
        {
            ...
            lista.adicionarNavio(navio);
            JOptionPane.showMessageDialog(null, "navio cadastrado!", "!!!", 1);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new NavioCadastro().setVisible(true));
    }
